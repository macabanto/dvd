...
function start_game() {//start button clicked
    ...
    window_size_x = window.innerWidth;//setting window size to fullscreen window values
    window_size_y = window.innerHeight; //setting window size to fullscreen window values
